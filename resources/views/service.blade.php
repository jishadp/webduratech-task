...
@section('content')
    ...
    <div class="mainDiv">
            ...
            <div class="holdr">
                    <div class="row">
                       <div class="stsDiv">
                          <div class="ststHead">Upcoming Request</div>
                    ...
                    <div class="row btnHldr">
                       <button class="btn w50 btn-primary">Check In</button>
                       <button class="btn w50 btn-primary doStatusChange" action="{{ route('change.status') }}" status="{{ encrypt(2) }}" book-id="{{ $booking->encrypted_id }}">Generate Invoice</button>
                    </div>
                 </div>
            @endforeach
            @if($bookings->count() == 0)
