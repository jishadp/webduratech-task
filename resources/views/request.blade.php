...
<div class="mainDiv">
    ...
    <div class="holdr">
            <div class="row">
               <div class="stsDiv">
                  <div class="ststHead">Pending Request</div>
            ...
            <div class="row btnHldr">
               <button class="btn w50 btn-primary">Reschedule</button>
               <button class="btn w50 btn-primary doStatusChange" action="{{ route('change.status') }}" status="{{ encrypt(1) }}1" book-id="{{ $booking->encrypted_id }}">Accept Request</button>
            </div>
         </div>
    @endforeach
   @if($bookings->count() == 0)
